                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>Queremos informarte que tu cita médica con el Dr./Dra. {{ $appointment->doctor->name . ' ' . $appointment->doctor->paternal_surname }} ha sido reprogramada según su solicitud.
                                                <br> <strong>Detalles de la cita:</strong>
                                            </p>
                                            <ul>
                                                <li>📅 Fecha: {{ $appointment->rescheduling_date }} (Anteriormente: {{ $appointment->date }})</li>
