...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE doctor_unavailabilities ADD CONSTRAINT unavailabilities_reason_check CHECK(reason IN('VACACIONES','ENFERMEDAD','DIA LIBRE','MATERNIDAD','NO ESPECIFICADO','RETIRADO'))");
    }
