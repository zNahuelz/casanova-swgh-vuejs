...
import {PATIENT_SEARCH_MODES as PSM} from "@/utils/constants.js";
...
async function loadPatients(filters = {}) {
  ...
  try {
    ...
    const response = await PatientService.get(filters, pagination);
...
onMounted(() => {
  document.title = 'ALTERNATIVA CASANOVA - LISTADO DE PACIENTES';
  loadPatients();
})
</script>
    ...
    <div class="container px-12 mx-auto">
      <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm w-full">
        ...
        <div v-if="isLoading" class="container mt-5 mb-5 flex flex-col items-center">
          ...
          <h1 class="mt-5 text-2xl font-light">Cargando pacientes...</h1>
        </div>
        ...
        <div v-if="!isLoading && !loadError" class="container mt-5 mb-5">
          <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
              ...
              <tbody>
              <tr
                  v-for="p in patients" :key="p.id" class="bg-white border-b border-gray-200 hover:bg-gray-50">
        ...
        <div v-if="loadError" class="container mt-5 mb-5 flex flex-col items-center space-y-5">
          ...
          <h1 class="text-2xl font-light">Oops! No se encontraron pacientes con los parametros ingresados. Intente
