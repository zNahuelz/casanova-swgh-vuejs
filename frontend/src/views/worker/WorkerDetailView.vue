...
async function loadWorker(id) {
  ...
  try {
    ...
    Swal.fire(EM.ERROR_TAG, EM.WORKER_NOT_FOUND, 'error').then((r) => {
  ...
  <main class="flex flex-col items-center pt-5">
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm  min-w-150">
      ...
      <div v-if="isLoading" class="container mt-5 mb-5 flex flex-col items-center">
        ...
        <h1 class="mt-5 text-2xl font-light">Cargando trabajador...</h1>
      </div>
      <div v-if="!isLoading && !loadError" class="space-y-3">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-3">
              ...
              <div>
                ...
                <div class="mt-1 text-sm text-gray-900">
                  {{ !worker?.createdBy ? 'INSERTADO EN BASE DE DATOS' : worker?.createdBy.username }}
                </div>
              </div>
            </div>
            <div class="space-y-3">
              ...
              <div>
                ...
                <div class="mt-1 text-sm text-gray-900">
                  {{ !worker?.updatedBy ? '---' : worker.updatedBy.username }}
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div>
            ...
            <input :value="worker?.worker?.id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full" disabled
                   type="text"/>
          </div>
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">Nombre</label>
            <input :value="worker?.worker?.name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full" disabled
                   type="text"/>
          </div>
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">Apellido Paterno</label>
            <input :value="worker?.worker?.paternal_surname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" disabled
                   type="text"/>
          </div>
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">Apellido Materno</label>
            <input :value="worker?.worker?.maternal_surname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full" disabled
                   type="text"/>
          </div>
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">DNI</label>
            <input :value="worker?.worker?.dni" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" disabled
                   type="text"/>
          </div>
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">E-Mail</label>
            <input :value="worker?.worker?.email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full" disabled
                   type="text"/>
          </div>
          <div class="md:col-span-2">
            <label class="block mb-1 text-sm font-medium text-gray-900 ">Dirección</label>
            <input :value="worker?.worker?.address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full" disabled
                   type="text"/>
          </div>
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">Teléfono</label>
            <input :value="worker?.worker?.phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" disabled
                   type="text"/>
          </div>
          <div>
          ...
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">Cargo</label>
            <input :value="worker?.worker?.position" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 w-full appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" disabled
                   type="text"/>
          </div>
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-900 ">Nombre de Usuario</label>
            <input :value="worker?.worker?.user?.username"
        ...
        <div class="flex justify-center mt-5">
          <div class="inline-flex rounded-md shadow-xs" role="group">
            ...
            <button class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-green-700 focus:z-10 focus:ring-2 focus:ring-green-700 focus:text-green-700 disabled:bg-gray-200 disabled:cursor-not-allowed" type="button"
                    @click="goToEdit(worker.worker.id)">
