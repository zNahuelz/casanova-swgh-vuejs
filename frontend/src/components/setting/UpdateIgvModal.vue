      ...
      <div class="p-6 space-y-6 items-center flex flex-col">
        ...
        <Form ref="igvForm" :initial-values="{
          ...
          <div>
            ...
            <Field id="igvValue" :validate-on-input="true" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                    focus:ring-green-600 focus:border-green-600 block w-full p-2.5" name="igvValue"
                   type="text"/>
