  ...
  <aside id="logo-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li v-if="authStore.getTokenDetails().role !== 'DOCTOR'">
          <button aria-controls="vouchers-dropdown"
            ...
            <svg aria-hidden="true"
                 ...
                 fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
                 xmlns="http://www.w3.org/2000/svg">
              <path clip-rule="evenodd" d="M7 6a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-2v-4a3 3 0 0 0-3-3H7V6Z"
                    fill-rule="evenodd"/>
              <path clip-rule="evenodd"
          ...
          <ul id="vouchers-dropdown" class="hidden py-2 space-y-2">
            <li>
              <router-link :to="{name: 'voucher-list'}"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-500"
              >Listado
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'refunds-list'}"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-500"
              >Reembolsos
              </router-link>
            </li>
        ...
        <li>
          <button aria-controls="medicines-dropdown"
                  class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-green-500"
                  data-collapse-toggle="medicines-dropdown" type="button">
            <svg aria-hidden="true"
                 class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                 fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
                 xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
          <button aria-controls="treatments-dropdown"
                  class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-green-500"
                  data-collapse-toggle="treatments-dropdown" type="button">
            <svg aria-hidden="true"
                 class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                 fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
                 xmlns="http://www.w3.org/2000/svg">
        ...
        <li @click="authStore.logout()">
          <a
            ...
            <svg
                aria-hidden="true"
                class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="none"
